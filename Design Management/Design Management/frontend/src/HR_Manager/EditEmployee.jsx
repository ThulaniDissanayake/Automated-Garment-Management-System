      ...
      <div className="main-content">
        ...
        <div className="main-content p-4">
          ...
          <div className="flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto">
            ...
            <div className="my-4">
              <label className="text-xl mr-4 text-gray-500">Upload Doc1</label>
              <input
                type="file"
            ...
            <div className="my-4">
              <label className="text-xl mr-4 text-gray-500">Upload Doc2</label>
              <input
                type="file"
            ...
            <div className="my-4">
              <label className="text-xl mr-4 text-gray-500">Upload Doc3</label>
              <input
                type="file"
